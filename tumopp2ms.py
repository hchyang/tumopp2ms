...
def parse_group(groupf=None):
    ...
    with open(groupf) as input:
        try:
            ...
            raise StopIteration('You group input file is empty!')
        header=header.rstrip()
        header=header.split()
...
def main():
    ...
    parser.add_argument('-x','--xrange',type=check_range,default=default,
        help='the range of x to pick [{}]'.format(default))
    default=None
    parser.add_argument('-y','--yrange',type=check_range,default=default,
        help='the range of y to pick [{}]'.format(default))
    default=None
    parser.add_argument('-z','--zrange',type=check_range,default=default,
        help='the range of z to pick [{}]'.format(default))
    default=None
